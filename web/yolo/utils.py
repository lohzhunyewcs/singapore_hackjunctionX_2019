...
def load_class_names(file_name):
    ...
    # print(f'realpath: {list(os.walk(dir_path))}')
    file_name = "D:\GitLab_respos\singapore_hackjunctionX_2019\singapore_hackjunctionX_2019\web\yolo\data\labels\coco.names"
...
def draw_boxes(img_names, boxes_dicts, class_names, model_size):
    ...
    for num, img_name, boxes_dict in zip(range(len(img_names)), img_names,
        ...
        font = ImageFont.truetype(font='D:/GitLab_respos/singapore_hackjunctionX_2019/singapore_hackjunctionX_2019/web/yolo/data/fonts/futur.ttf',
